...
const CreativeAI = ({ onBack }: Props) => {
  ...
  const generateOutline = async () => {
    ...
    // use open AI and complete this function
  ...
  return (
    ...
    >
      ...
      <motion.div variants={itemVariants} className="text-center space-y-2">
        ...
        <p className="text-primary-10">What would like to create today? </p>
      </motion.div>
      <motion.div
        className="bg-primary/10 p-4 rounded-xl mt-3"
      ...
      <div className="w-full flex justify-center items-center">
          <Button
          className="font-medium text-lg flex gap-2 items-center mt-4"

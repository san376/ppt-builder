...
const ThemePreview = (props: Props) => {
  ...
  const { currentTheme, setCurrentTheme, project } = useSlidesStore();
    ...
    <div className="space-y-4">
      <div className="rounded-xl p-6" style={{backgroundColor: selectedTheme.accentColor+'10'}}>
        ...
        <ul className="list-disc list-inside space-y-2" style={{color: selectedTheme.accentColor}}>
          ...
          <li>Accessibility optimize d</li>
        </ul>
      </div>
      <Button
      variant="outline"
  ...
  return (
    ...
    <div className="flex-grow overflow-y-auto">
      <div className="p-12 flex flex-col items-auto min-h-screen">
        <Button
        variant={"outline"}
        ...
        <ThemeCard
          ...
          description="Discovers what our themes can do"

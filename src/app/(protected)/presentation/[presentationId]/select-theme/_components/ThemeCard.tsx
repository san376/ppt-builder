        ...
        >
          ...
          <div className='flex flex-col md:flex-row'>
            ...
            <div className='relative w-full md:w-1/2 h-80 md:h-auto overflow-hidden rounded-r-lg'>
              <Image
              src="https://images.unsplash.com/photo-1741882239311-e769227bdee5?q=80&w=1932&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
              alt='Theme prevoew image'
              layout='fill'
              objectFit='cover'
